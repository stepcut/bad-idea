...
let
  ...
  f = { mkDerivation, attoparsec, attoparsec-binary, base, bytestring, deepseq
      ...
      mkDerivation {
        ...
        libraryHaskellDepends = [
          attoparsec attoparsec-binary base bytestring data-binary-ieee754 deepseq random tf-random stm linear gloss
